...
class ProductPage(BasePage):
    ...
    def should_be_product_name_message_equal_to_name(self):
        ...
        assert product_name_in_message == product_name, "Name of product in message doesn't match \
                                                         with name product that we added to basket"
    ...
    def should_be_cart_price_equal_to_price(self):
        ...
        assert price_message == price_message, "Price in message doesn't equal to price of product"
